          ...
          -->
                ...
                <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    <div class="flex shrink-0 items-center">
                        <img class="h-8 w-auto" src="https://www.svgrepo.com/show/521355/face-savoring-food.svg"
                            alt="Your Company" />
                    </div>
                    ...
                    <div class="relative ml-3">
                        <div>
                            <button type="button"
                                ...
                                <img class="size-8 rounded-full" src="https://www.svgrepo.com/show/446527/avatar.svg"
                                    alt="" />
                            </button>
                        </div>
